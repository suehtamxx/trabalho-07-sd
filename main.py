...
async def lifespan(app: FastAPI):
    db = SessionLocal()
    # Garantir que as tabelas existam antes de executar consultas
...
app = FastAPI(title="API Monolitica - Baseline Lenta", lifespan=lifespan)
...
def get_db():
    ...
    try:
        ...
        db.close()
# Popular o banco de dados será executado via lifespan
